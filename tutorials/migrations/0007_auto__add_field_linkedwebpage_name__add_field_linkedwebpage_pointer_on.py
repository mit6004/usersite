...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinkedWebPage.name'
        db.add_column('tutorials_linkedwebpage', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'LinkedWebPage.pointer_on_page'
        db.add_column('tutorials_linkedwebpage', 'pointer_on_page', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LinkedWebPage.name'
        db.delete_column('tutorials_linkedwebpage', 'name')

        # Deleting field 'LinkedWebPage.pointer_on_page'
        db.delete_column('tutorials_linkedwebpage', 'pointer_on_page')
