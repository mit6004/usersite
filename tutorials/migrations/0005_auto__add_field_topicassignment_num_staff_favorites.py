...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopicAssignment.num_staff_favorites'
        db.add_column('tutorials_topicassignment', 'num_staff_favorites', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TopicAssignment.num_staff_favorites'
        db.delete_column('tutorials_topicassignment', 'num_staff_favorites')
