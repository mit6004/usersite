...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Quiz.quiz_date'
        db.add_column('tutorials_quiz', 'quiz_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Quiz.quiz_date'
        db.delete_column('tutorials_quiz', 'quiz_date')
