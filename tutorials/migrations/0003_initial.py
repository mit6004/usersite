...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ViewInterval'
        db.create_table('tutorials_viewinterval', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ta', self.gf('django.db.models.fields.related.ForeignKey')(related_name='intervals', to=orm['tutorials.TopicAssignment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('start_time', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('stop_time', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('tutorials', ['ViewInterval'])

        # Adding unique constraint on 'ViewInterval', fields ['ta', 'user', 'time']
        db.create_unique('tutorials_viewinterval', ['ta_id', 'user_id', 'time'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ViewInterval', fields ['ta', 'user', 'time']
        db.delete_unique('tutorials_viewinterval', ['ta_id', 'user_id', 'time'])
        ...
        # Deleting model 'ViewInterval'
        db.delete_table('tutorials_viewinterval')
    ...
    models = {
        ...
        'tutorials.viewinterval': {
            'Meta': {'unique_together': "(('ta', 'user', 'time'),)", 'object_name': 'ViewInterval'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_time': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'stop_time': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'ta': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'intervals'", 'to': "orm['tutorials.TopicAssignment']"}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }
