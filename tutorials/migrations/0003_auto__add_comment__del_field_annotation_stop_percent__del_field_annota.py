...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Annotation.stop_percent'
        db.delete_column('tutorials_annotation', 'stop_percent')

        # Deleting field 'Annotation.start_percent'
        db.delete_column('tutorials_annotation', 'start_percent')

        # Adding field 'Annotation.start_time'
        db.add_column('tutorials_annotation', 'start_time', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Annotation.stop_time'
        db.add_column('tutorials_annotation', 'stop_time', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Annotation.stop_percent'
        db.add_column('tutorials_annotation', 'stop_percent', self.gf('django.db.models.fields.FloatField')(default=100.0), keep_default=False)

        # Adding field 'Annotation.start_percent'
        db.add_column('tutorials_annotation', 'start_percent', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Deleting field 'Annotation.start_time'
        db.delete_column('tutorials_annotation', 'start_time')

        # Deleting field 'Annotation.stop_time'
        db.delete_column('tutorials_annotation', 'stop_time')
