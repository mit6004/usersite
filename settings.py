...
DATABASE_NAME = '/home/caitlinj/website/djcode/usersite.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'fh=$_^h7^vd#nmd9sxn$1&@o^m^-3gx2llk6htjnb1$hxx5fo6'
